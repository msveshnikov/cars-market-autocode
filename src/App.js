...
const App = () => {
  ...
  const brands = [
    "volkswagen", "sonstige_autos", "lancia", "ford", "opel", "mercedes_benz", "toyota",
    "audi", "bmw", "mitsubishi", "fiat", "nissan", "renault", "mazda", "subaru",
    "peugeot", "smart", "mini", "hyundai", "dacia", "porsche", "alfa_romeo", "daewoo",
    "saab", "kia", "chevrolet", "volvo", "skoda", "seat", "citroen", "suzuki", "honda",
    "jeep", "jaguar", "daihatsu", "land_rover", "chrysler", "rover", "lada",
  ];
